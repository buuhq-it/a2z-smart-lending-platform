...
import {LayoutFloatingConfigurator} from '../layouts/layout.floatingconfigurator';

@Component({
    selector: 'auth-forbidden',
    standalone: true,
    imports: [ButtonModule, RouterModule, RippleModule, LayoutFloatingConfigurator, ButtonModule],
    template: `
      <layout-floating-configurator />
